...
public class Cutter : MonoBehaviour
{
    ...
    public static void Cut(GameObject originalGameObject, Vector3 contactPoint, Vector3 cutNormal)
    {
        ...
        // 원래 오브젝트의 매터리얼 가져오기
        Material originalMaterial = originalGameObject.GetComponent<MeshRenderer>().material;
    ...
    // Apply material to game object's mesh renderer
    private static void ApplyMaterial(GameObject gameObject, Mesh mesh, Material material)
    {
